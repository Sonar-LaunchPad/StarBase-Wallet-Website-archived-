    ...
    <div className="Wallet">
      ...
      <Container>
        <div className="Section-image-info">
          <div className="Section-info">
            Starbase is more than just another multi-currency wallet. It’s one of the few wallets out there that adheres to standards and
      ...
      <Container>
        <div className="Section-head">
          ...
          <div className="Section-info">
            Manage your assets in a responsive and user-friendly interface. Starbase engineered using native iOS and Android programming languages
